...
thermal_socks:`<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><image href="https://lftz25oez4aqbxpq.public.blob.vercel-storage.com/image-pAphNcX4MZejsiAhsk6GaGPMsMeUpS.png" x="0" y="0" width="20" height="20"/></svg>`,
...
camera:`<svg viewBox="0 0 20 20" fill="none"><rect x="1.5" y="6.5" width="17" height="12" rx="2.5" fill="#0f172a" opacity="0.35"/><rect x="2" y="6" width="17" height="12" rx="2.5" fill="#1e293b"/><rect x="1" y="5.5" width="17" height="12" rx="2.5" fill="#334155"/><rect x="1" y="5.5" width="17" height="4" rx="2.5" fill="#475569"/><path d="M7 5 L8 3 L12 3 L13 5Z" fill="#334155"/><rect x="7" y="2.5" width="5" height="2.5" rx="1" fill="#1e293b"/><circle cx="9.5" cy="13" r="4.5" fill="#1e293b"/><circle cx="9.5" cy="13" r="3.5" fill="#475569"/><circle cx="9.5" cy="13" r="2" fill="#0ea5e9"/><circle cx="9.5" cy="13" r="1" fill="#0369a1"/><ellipse cx="8" cy="12" rx="0.8" ry="0.6" fill="rgba(255,255,255,0.3)"/><circle cx="14" cy="8" r="1.2" fill="#fbbf24"/></svg>`,
...
sleeping_bag:`<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><image href="https://lftz25oez4aqbxpq.public.blob.vercel-storage.com/image-xL1M3C7HGRm4rafXfEYw3cQXkfiQyw.png" x="0" y="0" width="20" height="20"/></svg>`,
