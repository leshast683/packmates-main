...
(function () {
  ...
  // Second-chance removal of index.html's Quick Actions card: this script
  // loads after index.js and its own bento render, so by the time we get
  // here the Capacitor bridge has had strictly more time to attach than
  // index.js's own inline check did - catches it even on the rare case
  // where index.js's own 400ms self-heal timeout also lost the race.
