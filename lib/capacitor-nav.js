...
(function () {
  ...
  if (packingSvg) {
    packingSvg.outerHTML = '<svg viewBox="0 0 24 24"><path d="M7 9a2 2 0 012-2h6a2 2 0 012 2v10a2 2 0 01-2 2H9a2 2 0 01-2-2V9z"/><path d="M9 7V6a2 2 0 012-2h2a2 2 0 012 2v1"/><path d="M9 12h6a1 1 0 011 1v3a1 1 0 01-1 1H9a1 1 0 01-1-1v-3a1 1 0 011-1z"/><path d="M10.5 15.5h3"/></svg>';
  }
